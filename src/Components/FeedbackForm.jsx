...
//     <div className="max-w-4xl py-6 font-sans bg-white">

//       <div className={`${showThankYou ? "blur-sm pointer-events-none select-none" : ""}`}>
//         <button
...
//         <h4 className="text-4xl font-bold text-[#003a84] mb-2">Customer Feedback</h4>
...
//             className={`w-full h-[50px] bg-[#003a84] text-white rounded-lg font-medium hover:bg-[#002a5e] ${
...
//           <button
//             type="button"
//             className="w-full h-[50px] border-2 border-[#003a84] text-[#003a84] rounded-lg font-medium hover:bg-[#003a84] hover:text-white"
...
//               <p className="mb-4 font-semibold text-lg text-[#003a84]">
