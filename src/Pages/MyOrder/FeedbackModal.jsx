...
// </div>
//           <h2 className="text-2xl font-semibold text-[#013686] mb-1">
...
//           <div className="w-full border rounded-lg overflow-hidden mb-4 px-4 py-2">
...
//                 <h3 className="font-semibold text-right  text-sm">
...
//             <button
//               className="bg-[#013686] text-white py-2 rounded-md hover:bg-[#012c59] transition"
//               onClick={onSubmit}
//             >
//               Submit Feedback
//             </button>
//             <button
//               className="border border-gray-300 py-2 rounded-md hover:bg-gray-100 transition"
//               onClick={onCancel}
//             >
//               Cancel
//             </button>
